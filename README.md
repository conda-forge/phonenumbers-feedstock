...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/phonenumbers-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/phonenumbers-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add phonenumbers
# for installing globally
pixi global install phonenumbers
```
...
It is possible to list all of the versions of `phonenumbers` available on your platform:
...
```
pixi search phonenumbers --channel conda-forge
```
